    ...
    <div class="full-height">
        ...
        <div>
            ...
            <q-scroll-area
                ...
                ref="firstRef"
                >
                <div v-for="participantResult in participantResults" :key="participantResult.user_id" class="q-pa-sm">
                    <div class="row justify-content">
                        <div class="row">
                            <span class="label bg-white text-black"> {{ participantResult.user_name }} </span>
                            <q-separator/>
                        </div>
                        <div>
                            ...
                            <q-card>
                                ...
                                <q-card-section class="q-pt-none">
                                    <div class= "col" v-for="codingAnswer in participantResult.interviewCodingQuestionResults" :key="codingAnswer.question_id_name">
                                        <div class= "row justify-content">
                                            <span>{{ codingAnswer.question_id_name }}</span>
                                            <q-btn flat label="See Answer" @click="secondDialog = true"></q-btn>

                                            <q-dialog v-model="secondDialog">
                                                <q-card style="width:600px; height:600px;" >
                                                    <q-card-section>
                                                        <div class="text-h6"> {{codingAnswer.question_name}} </div>
                                                    </q-card-section>
                                    ...
                                    <div class= "row" v-for="nonCodingAnswer in participantResult.interviewNonCodingQuestionResults" :key="nonCodingAnswer.question_id_name">
                                        <div class= "row justify-content">
                                            <span>{{ nonCodingAnswer.question_id_name }}</span>
                                            <q-btn flat label="See Answer" @click="thirdDialog = true"></q-btn>

                                            <q-dialog v-model="thirdDialog">
                                                <q-card style="width:600px; height:600px;" >
                                                    <q-card-section>
                                                        <div class="text-h6"> {{ nonCodingAnswer.question_name}} </div>
                                                    </q-card-section>
