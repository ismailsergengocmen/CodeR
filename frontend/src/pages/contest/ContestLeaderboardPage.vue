  ...
  <div>
    ...
    <div>
      <q-scroll-area visible style="height: 300px" class="col" ref="firstRef">
        <div
          v-for="contestant in leaderboard"
          :key="contestant.interview_id"
          class="q-pa-sm"
        >
          <div class="row justify-content">
            ...
            <div class="col">
              <span class="label bg-white text-black">
                POINT: {{ contestant.total_point }}
              </span>
            </div>

            <div class="col">
              <span class="label bg-white text-black">
                FINISH TIME: {{ contestant.total_finish_time_duration }}
              </span>
            </div>

            <div class="col">
              <span class="label bg-white text-black">
                ATTEMPT COUNT: {{ contestant.total_attempt_count }}
              </span>
            </div>
          </div>
        </div>
